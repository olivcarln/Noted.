...
{{-- <div class="mb-3">
    <label for="jabatan" class="form-label text-uppercase text-pink fw-semibold small">Position</label>
    <input type="text" id="jabatan" name="jabatan" value="{{ old('jabatan', $employee->jabatan) }}" class="form-control form-control-md @error('jabatan') is-invalid @enderror" placeholder="Example: Staff, Admin">
...
<input id="note-title"  class="title-input fw-bold" style="letter-spacing: 0.05em;" type="text" name="title"  placeholder="Title" value="{{ old('title', $note->title) }}"
    ...
    <!-- Editor -->
        ...
        <div id="editor" spellcheck="false">
            <input 
              ...
              style="border: none; outline: none; background: transparent; font-size: 1rem; width: 100%; color: black;" 
            />
          </div>
